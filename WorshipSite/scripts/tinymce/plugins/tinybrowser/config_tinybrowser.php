...
$tinybrowser['obfuscate'] = 'Gr3at1sG0d!!!111';
...
$tinybrowser['path']['image'] = '/UserFiles/Image/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
